...
export default function UserProfile() {
  ...
  return (
    <div>
      <div className="mx-auto bg-white max-w-7xl  sm:px-6 h-screen">
        ...
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          ...
          {showAddAddressForm ? (
            ...
            >
              <div className="space-y-12">
                <div className="border-b border-gray-900/10 pb-12 rounded-md">
          ...
          {userInfo.addresses.map((address, index) => (
            <div key={index}>
              ...
              <div className=" mt-2 flex justify-between gap-x-6 px-5 py-5 border-solid border-2 border-gray-200 rounded-md">
