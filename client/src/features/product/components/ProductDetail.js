      ...
      {product && (
        <div className="pt-6">
          ...
          {/* <div className="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
            <div className="aspect-h-4 aspect-w-3 hidden overflow-hidden rounded-lg lg:block object-contain">
              <img
            ...
            <div className="object-contain aspect-h-5 aspect-w-4 lg:aspect-h-4 lg:aspect-w-3 sm:overflow-hidden sm:rounded-lg">
              <img
                className="h-full w-full object-cover object-contain"
                      ...
                      <StarIcon
                        ...
                        className={classNames(
                          product.rating > rating
                            ? "text-gray-900 fill-yellow-950"
                            : "text-gray-200 fill-yellow-950",
                          "h-5 w-5 flex-shrink-0 fill-yellow-950"
                        )}
                        aria-hidden="true"
                      />
                    ))}
